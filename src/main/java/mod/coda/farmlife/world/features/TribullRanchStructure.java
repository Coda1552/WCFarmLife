package mod.coda.farmlife.world.features;
...
import mod.coda.farmlife.init.FLStructures;
...
public class TribullRanchStructure extends Structure<NoFeatureConfig> {
    private static final ResourceLocation LOOT = new ResourceLocation(FarmLife.MOD_ID, "structures/tribull_ranch_chest");
        ...
        protected void handleDataMarker(String function, BlockPos pos, IServerWorld worldIn, Random rand, MutableBoundingBox sbb) {
            if ("barrel".equals(function)) {
                ...
                if (tileentity instanceof BarrelTileEntity) {
                    ((BarrelTileEntity) tileentity).setLootTable(LOOT, rand.nextLong());
                }
            }
            if ("adult".equals(function)) {
                worldIn.setBlock(pos, Blocks.AIR.defaultBlockState(), 2);
                DomesticTribullEntity entity = FlLifeEntities.DOMESTIC_TRIBULL.get().create(worldIn.getLevel());
                if (entity != null) {
