...
public abstract class GalliraptorModel<T extends Entity> extends SegmentedModel<GalliraptorEntity> {
    ...
    public static class Adult extends GalliraptorModel{
        ...
        protected void setAngles() {
            ...
            this.tailbase.setRotationPoint(0.0F, -1.5F, 3.0F);
    ...
    @Override
    public void setRotationAngles(GalliraptorEntity entityIn, float f, float f1, float ageInTicks, float netHeadYaw, float headPitch) {
        float speed = 1.0f;
        float degree = 1.0f;
        if (this.isChild) {
            this.head_baby.rotateAngleX = headPitch * ((float)Math.PI / 180F);
            this.head_baby.rotateAngleY = netHeadYaw * ((float)Math.PI / 180F);
            this.head_baby.rotateAngleX = MathHelper.cos(2.0F + f * speed * 0.4F) * degree * 0.2F * f1 - 0.1F;
            this.rightleg_baby.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * 1.0F * f1;
            this.leftleg_baby.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * -1.0F * f1;
            this.tail_baby.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * 0.3F * f1 - 0.2F;
        } else {
            this.head.rotateAngleX = headPitch * ((float)Math.PI / 180F);
            this.head.rotateAngleY = netHeadYaw * ((float)Math.PI / 180F);
            this.head.rotateAngleX = MathHelper.cos(2.0F + f * speed * 0.4F) * degree * 0.2F * f1 - 0.1F;
            this.rightleg.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * 1.0F * f1;
            this.leftleg.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * -1.0F * f1;
            this.tailbase.rotateAngleX = MathHelper.cos(2.0F + f * speed * 0.4F) * degree * 0.5F * f1 + 0.35F;
            this.tail.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * 0.3F * f1 - 0.2F;
            this.tailbase.rotateAngleY = MathHelper.cos(f * speed * 0.2F) * degree * 0.4F * f1;
            this.leftwing.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * 0.3F * f1 + 0.3F;
            this.leftwing.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * -0.4F * f1 - 0.1F;
            this.rightwing.rotateAngleZ = MathHelper.cos(f * speed * 0.4F) * degree * 0.4F * f1 + 0.1F;
            this.rightwing.rotateAngleX = MathHelper.cos(f * speed * 0.4F) * degree * 0.3F * f1 + 0.3F;
        }
    }
